...
This image shows how the pyML module can be imported and train the models. The module generates the accuracy and confusion matrix for any given on all of the models described above. The pyML module also generates ROC curves for each model which can be seen below.
